...
רצוי לדעת טוב מאוד את הקורסים הטכניים שלמדתם: מבוא למדמח, מבוא לחומרה, תכנות מונחה עצמים, שפות סף ומבנה מהדרים.
רצוי לזכור ידע בסיסי במתמטיקה וכן נושאים מרכזיים מהקורסים המתמטיים.

ניתן להתאמן על [אתגרי hackme](https://goo.gl/GGZ2Yr) וללמוד נושאיים מעשיים בתכנות ובאבטחת מחשבים שלא נלמדו בקורסים באוניברסיטה. ללמוד ולעשות פרויקטים מחוץ למסגרות הלימודים יעצימו את הידע שלכם ואת התאמתכם לכל תפקיד טכנולוגי.
